const contractAddress = "0xdA09e67D30924B8B7b0140e48b819C6E7b36E649"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the RAFFY COLLECTION!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The RAFFY NFT COLLECTION is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
